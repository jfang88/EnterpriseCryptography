...
**Version:** 2.3 (HYBRID DOMAIN + OPERATIONAL DETAIL RESTORED + CSA CCM + CAP. 653 TIERING)  
**Date:** March 2026  
...
**Status:** DRAFT — Hybrid Control-Domain Rewrite with Restored Operational Detail, CSA CCM Crosswalk, and Cap. 653 Tiering Overlay, CSA CCM Crosswalk, and Cap. 653 Tiering Overlay
...
- [3. Governance and Standards Alignment](#3-governance-and-standards-alignment)
  ...
  - [3.2 Cap. 653 Tier 0 and Tier 1 Control Objectives](#32-cap-653-tier-0-and-tier-1-control-objectives)
  - [3.3 Regulated Entity Obligations for Financial Services CI](#33-regulated-entity-obligations-for-financial-services-ci)
  - [3.4 Enterprise System Tiering Model](#34-enterprise-system-tiering-model)
  - [3.5 Regulatory and Standards Mapping](#35-regulatory-and-standards-mapping)
  - [3.6 Compliance Calendar](#36-compliance-calendar)
...
All cryptographic and computer-system security controls in this document derive from the following hierarchy. Higher tiers take precedence. Within the same tier, jurisdiction-specific requirements take precedence where legally applicable.

| Tier | Framework | Status | Core Relevance |
| :-- | :-- | :-- | :-- |
| 0 | Hong Kong Cap. 653 Protection of Critical Infrastructures (Computer Systems) Ordinance | Mandatory legal authority | Statutory obligations for designated critical infrastructure operators and critical computer systems |
| 1 | Enterprise security policy and this guideline | Mandatory internal authority | Enterprise-wide implementation of legal, regulatory, and control objectives |
...
| 2 | CSA Cloud Controls Matrix | Normative explanatory clustering | Cloud shared-responsibility and cloud-control domain mapping |
...
```mermaid
graph TD
    A[Tier 0 Legal Authority - Cap. 653] --> B[Tier 1 Enterprise Policy and Control Objectives]
    B --> C[Tier 2 NIST FIPS CSA Cryptographic and Control Frameworks]
    C --> D[Tier 3 International Assurance Standards]
    D --> E[Tier 4 Platform and Implementation Guidance]
```

### 3.2 Cap. 653 Tier 0 and Tier 1 Control Objectives

Cap. 653 is an Ordinance to protect the security of the computer systems of Hong Kong's critical infrastructures and to regulate the operators of those infrastructures. Schedule 1 specifies sectors for the definition of critical infrastructure, and the listed sectors include banking and financial services.

For this guideline, Cap. 653 is treated as the **Tier 0** legal driver for regulated critical-infrastructure obligations, while this document acts as the **Tier 1** enterprise implementation standard that converts those legal duties into technical, operational, and evidentiary requirements across all systems.

#### Tier 0 Legal Control Objectives

The following legal control objectives are derived from the Ordinance and related official summaries for designated operators:
- Establish and maintain organisational capability for computer-system security.
- Identify and govern critical computer systems that are essential to the core function of the infrastructure.
- Implement and maintain a computer-system security management plan.
- Notify material changes affecting operators or critical computer systems.
- Conduct regular risk assessments and independent audits.
- Report and respond to computer-system security incidents.

#### Tier 1 Enterprise Control Objectives

This guideline operationalises those legal objectives by requiring:
- Enterprise-wide cryptographic, key-management, secret-management, and certificate controls for all systems.
- Stronger design, custody, logging, testing, and recovery controls for Critical Systems.
- The strictest governance, monitoring, audit, and incident obligations for Critical Computer Systems and equivalent crown-jewel services.

### 3.3 Regulated Entity Obligations for Financial Services CI

Assuming the organisation is a financial services critical infrastructure provider, the following Cap. 653 obligations are the most relevant baseline requirements for this document.

| Obligation Category | Requirement Theme | Practical Meaning for This Guideline |
| :-- | :-- | :-- |
| Category 1 — Organisational | Maintain an office in Hong Kong | Legal operating presence and regulatory contact capability |
| Category 1 — Organisational | Notify operator changes | Ownership, control, or operator changes must be governed and escalated |
| Category 1 — Organisational | Set up and maintain a computer-system security management unit | Formal cyber governance structure with named responsibility |
| Category 2 — Preventive | Notify material changes to critical computer systems | Architecture, platform, or major dependency changes require governance and notice |
| Category 2 — Preventive | Submit and implement a computer-system security management plan | Management plan becomes a mandatory control artefact |
| Category 2 — Preventive | Conduct annual security risk assessments | At least annual risk reassessment for regulated critical environments |
| Category 2 — Preventive | Arrange biennial security audits | Independent periodic assurance of control operation |
| Category 3 — Incident Reporting and Response | Report and respond to incidents | Incident escalation, containment, evidence retention, and regulator-facing procedures |

#### Relevant CCS Identification Logic

Official and sector commentary on the Ordinance indicates that operators must determine whether a computer system constitutes a critical computer system by considering the role and core function of the system, the extent of relatedness with other computer systems, and the extent of relatedness with other critical infrastructure operators.

Examples described for CCS scope include systems that store or process sensitive digital data used directly in the provision of banking services, systems that directly protect the security or resilience of other CCSs such as security gateways, firewalls, and backup facilities in high-availability environments, and operational technology systems where relevant.

For a financial services operator, that means the scope should not be limited to front-office banking or payment applications alone. Identity systems, key-management services, security gateways, privileged access systems, high-availability recovery platforms, and other dependencies may also require treatment as Critical Systems or CCS-aligned services when they are essential to core operations.

### 3.4 Enterprise System Tiering Model

This guidance document applies to **all systems**. However, legal and operational criticality requires a stricter tiering model so that requirements intensify for systems that directly support regulated critical services.

| Tier | System Class | Applicability |
| :-- | :-- | :-- |
| Enterprise Baseline | All systems | Mandatory minimum controls for cryptography, secrets, certificates, logging, and secure configuration |
| Enhanced | Critical Systems | Stronger architecture review, segregation, logging, recovery testing, and privileged-access control |
| Highest | Critical Computer Systems (CCS) and equivalent crown-jewel services | Formal governance, regulator-facing evidence, annual risk assessment, biennial audit, incident readiness, and stricter technical enforcement |

#### Tiering Rules

- **All systems** SHALL follow the baseline control requirements in this document.
- **Critical Systems** SHALL apply enhanced controls where compromise would materially affect authentication, encryption, transaction integrity, customer data protection, resilience, or recovery.
- **Critical Computer Systems** and equivalent crown-jewel services SHALL apply the strictest requirements in this guideline, including explicit design approval, tighter key custody, stronger monitoring, tested recovery, and evidence preservation suitable for regulatory scrutiny.

#### Typical Financial Services Examples

| Example System | Suggested Tier |
| :-- | :-- |
| Internal collaboration site with no regulated transaction dependency | Enterprise Baseline |
| CI/CD system signing production releases | Critical System |
| KMS, HSM, token-signing, payment-switch, or core banking dependency | CCS / Highest |
| Security gateway, PAM vault, or HA recovery control plane protecting core banking services | CCS / Highest |

### 3.5 Regulatory and Standards Mapping

| Control Need | Primary Enterprise Domain | Helpful NIST CSF 2.0 Function | Helpful NIST SP 800-53 Families | Helpful CSA CCM Domain(s) | Cap. 653 Relevance |
| :-- | :-- | :-- | :-- | :-- | :-- |
| Policy, roles, exceptions | GRC | Govern | PL, PM, RA | GRC | Security management unit and organisational obligations |
| Key lifecycle and approved algorithms | CEK | Protect | SC, CM | CEK | Part of management plan, risk treatment, and evidence of secure operation |
| Access to cryptographic services | IAM | Protect | AC, IA | IAM | Protection of critical and supporting systems |
| Storage and transit encryption | DSP | Protect | SC | DSP, CEK | Baseline protection expected for sensitive banking and operational data |
| Logging and alerting | LOG | Detect | AU, SI | LOG | Supports investigation, reporting, and evidence retention |
| Incident handling and recovery | IR | Respond / Recover | IR, CP | SEF, BCR | Category 3 incident reporting and response obligations |
| Vendor and library governance | STA | Govern | SR, SA | STA, A&A, IPY | Dependency and service-provider governance for critical environments |
| Infrastructure and secure baseline concerns | TVM | Protect | SC, CM, SA | IVS, CCC, TVM | Supports identification and protection of regulated critical systems |

### 3.6 Compliance Calendar

| Date / Trigger | Milestone | Action Required |
| :-- | :-- | :-- |
| Immediately for designated / likely-designated operators | Determine likely CI / CCS scope | Map financial-services critical services, supporting systems, and key dependencies |
| Annually | Computer-system security risk assessment | Reassess regulated critical environments and linked cryptographic dependencies |
| Every 2 years | Computer-system security audit | Arrange independent audit for regulated critical environments |
| On material change | Notify and govern change | Escalate material changes affecting operator status, CCS scope, or regulated system architecture |
| On incident | Report and respond | Follow incident response, evidence retention, and regulator-facing reporting procedures |
| Continuous | Enterprise baseline upkeep | Maintain inventory, monitoring, rotation, exception governance, and recovery readiness |
